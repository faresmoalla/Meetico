...
public class TripController {
	...
	@GetMapping("/List-voyage-by-entrepreneur/{id-Ent}")
	@ResponseBody
	public Set<Trip> ListVoyageByEnt(@PathVariable("id-Ent") Long idEnt) {
		return tripService.affichetListVoyageByEntrepreneur(idEnt);
