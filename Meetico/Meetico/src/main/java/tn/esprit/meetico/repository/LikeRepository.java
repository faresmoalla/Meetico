...
public interface LikeRepository extends JpaRepository<PostLike, Long> {
	...
	@Query("SELECT l from PostLike l where l.utilis.userId= :userId  AND l.publication.idPublication= :idPublication AND l.publication.userr.userId= l.utilis.userId "
			)
