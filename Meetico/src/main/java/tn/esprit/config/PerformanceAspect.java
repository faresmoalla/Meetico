...
import tn.esprit.repository.StatMeilleurDesitnationRepository;
import tn.esprit.service.TripServiceImpl;
...
return obj;
	...
	@After("execution(public String tn.esprit.service.TripServiceImpl.favoriteDestination())")
