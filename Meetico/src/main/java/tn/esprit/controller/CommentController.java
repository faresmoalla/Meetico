...
public class CommentController {
	...
	public void updateComment(@PathVariable("idComment") Long idComment,
			@PathVariable("idPublication") Long idPublication, @PathVariable("idUtilisateur") Long idUtilisateur) {
