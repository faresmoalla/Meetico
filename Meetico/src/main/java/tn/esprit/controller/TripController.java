...
public class TripController {
	...
	public List<User> afficherutilisateurbymatching(@PathVariable("destination") String destination,@PathVariable("startdate") java.sql.Date startdate){
		return tripService.afficherutilisateurbymatching(destination,startdate);
	}
	@PutMapping("/delete-userfromtrip/{id-trip}/{userid}")
	@ResponseBody
	public void deletetrip( @PathVariable("id-trip") Integer idtrip,@PathVariable("userid") List<Long> idusers){
